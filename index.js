...
function sonCesitiKaldir(gorev5){
  let yeniTat = gorev5.pop();
  return gorev5
}
...
function ismeGoreCesitCikar(tatlar, lezzet){
  let Tarcin = tatlar.indexOf(lezzet)
  let sonTat = tatlar.splice(Tarcin,1)
  return tatlar
}
